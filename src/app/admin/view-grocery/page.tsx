    ...
    <div className="pt-4 w-[95%] md:w-[85%] mx-auto pb-20">
      ...
      >
        ...
        <input
          ...
          placeholder="Search by name or categry..."
        />
      </motion.form>
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-between w-full">
              ...
              <div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                ...
                <button className='bg-green-600 text-white cursor-pointer px-4 py-2 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-green-700 transition-all' onClick={()=>setEditing(g)}>
                    <Pencil size={15}/>Edit
                </button>
              </div>
            </div>
