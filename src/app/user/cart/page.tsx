...
function CartPage() {
  ...
  return (
    ...
    <Link href={'/'} className='absolute -top-2 left-0 text-green-700 rounded-full font-medium flex items-center  shadow-md hover:text-green-800'>
    <ArrowLeft size={20}/>
    ...
    >
        ...
        {cartData.length == 0 ? (
            ...
            >
                ...
                <Link href={'/'} className='bg-green-600 text-white py-3 px-6  rounded-full hover:bg-green-800 transition-all inline-block font-medium'>
                    Continue Shopping
                </Link>
                ...
                <div>
                    <AnimatePresence>
                        {cartData.map((item,index)=>(
                            ...
                            >
                                <div className='relative w-28 h-28 sm:w-24 sm:h-24 md:w-28 md:h-28 flex-shrink-0 bg-gray-50 rounded-xl overflow-hidden'>
                                ...
                                <div className='mt-4 sm:mt-0 sm:ml-4 flex-1 text-center sm:text-left'>
                                    ...
                                    <p className='text-xs sm:text-sm text-gray-500'>Quantity: {item.unit}</p>
                                ...
                                <button className='sm:ml-4 mt-3 sm:mt-0 text-red-500 hover:text-red-700'><Trash2 size={18} /></button>
