...
function HeroSection() {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle:
        "We ensure your groceries arrive on time, every time, with our efficient delivery service.",
      btnText: "Order Now",
    ...
    <div className="relative w-[98%] mx-auto mt-28 h-[80vh] rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-5xl md:text-6xl font-extrabold tracking-tight drop-shadow-lg">
