  ...
  return (
    <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10'>
            ...
            <select className='border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-500 outline-none transition w-full sm:w-auto cursor-pointer'
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-md p-5 mb-10">
          <h2 className="text-lg font-semibold text-gray-700 mb-4">Orders Overview (Last 7 Days)
          </h2>
