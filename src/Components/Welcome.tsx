  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6'>
        ...
        transition={{ duration: 1 }} className='flex items-center'>
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.8 }} className='inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-14 rounded-2xl shadow-md transition-all duration-200 mt-10'>
                Next
                <ArrowRight/>
            </motion.button>
